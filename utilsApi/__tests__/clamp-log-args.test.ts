...
describe('clampArgs', () => {
  test('bounds a single oversized string', () => {
  ...
  test('flattens an Error and clamps its message', () => {
  ...
  test('survives cycles, deep nesting and throwing getters', () => {
  ...
  test('does not report a repeated object as a cycle', () => {
    const shared = { a: 1 };
  ...
  test('keeps masking cost bounded for an oversized payload', () => {
