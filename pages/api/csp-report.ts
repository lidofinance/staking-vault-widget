...
// each report includes the full `original-policy` string plus `document-uri`
// / `referrer` / `source-file` / `script-sample`. The Reporting API v1
// batches multiple reports in a single array, so 8KB is too tight in
