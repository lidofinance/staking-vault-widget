...
export const DefaultTier: FC<DefaultTierProps> = ({ variant }) => {
  ...
  return (
    <Text size="xxs">
      ...
      this stVault is currently in the Default Tier. This interface does not
      allow supplying ETH, repaying stETH, or rebalancing in this case due to a
      higher risk of fund loss. To enable these actions in the web interface,
      the stVault{' '}
      <NextLink href={link}>
